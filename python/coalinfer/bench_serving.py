...
python3 -m coalinfer.bench_serving --backend coalinfer --dataset-name random --num-prompts 3000 --random-input 1024 --random-output 1024 --random-range-ratio 0.5
python3 -m coalinfer.bench_serving --backend coalinfer --dataset-name random --request-rate-range 1,2,4,8,16,32 --random-input 4096 --random-output 1024 --random-range-ratio 0.125 --multi
"""
...
def get_model(pretrained_model_name_or_path: str) -> str:
    if os.getenv("COALINFER_USE_MODELSCOPE", "False").lower() == "true":
...
ASYNC_REQUEST_FUNCS = {
    "coalinfer": async_request_openai_completions,
