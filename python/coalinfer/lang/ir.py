...
from coalinfer.lang.choices import ChoicesSamplingMethod
...
class SglFunction:
    ...
    def run(
        ...
        **kwargs,
        ...
        from coalinfer.lang.interpreter import run_program
    ...
    def run_batch(
        ...
        *,
        ...
        from coalinfer.lang.interpreter import run_program_batch
    ...
    def trace(self, *, backend=None, **kwargs):
        from coalinfer.lang.tracer import trace_program

        backend = backend or global_config.default_backend
        return trace_program(self, kwargs, backend)

    def cache(self, backend=None):
        from coalinfer.lang.interpreter import cache_program

        backend = backend or global_config.default_backend
        return cache_program(self, backend)

    def compile(self, *, backend=None):
        from coalinfer.lang.compiler import compile_func

        return compile_func(self, backend)

    def __call__(self, *args, **kwargs):
        from coalinfer.lang.tracer import TracingScope
