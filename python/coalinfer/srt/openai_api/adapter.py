...
from coalinfer.srt.conversation import (
    Conversation,
    SeparatorStyle,
...
from coalinfer.srt.managers.io_struct import EmbeddingReqInput, GenerateReqInput
from coalinfer.srt.openai_api.protocol import (
    BatchRequest,
    BatchResponse,
...
# map file id to file path in Coalinfer backend
...
async def v1_files_create(file: UploadFile, purpose: str, file_storage_pth: str = None):
    try:
        ...
        # Save the file to the coalinfer_oai_storage directory
...
async def process_batch(tokenizer_manager, batch_id: str, batch_request: BatchRequest):
    try:
        ...
        logger.error("error in Coalinfer:", e)
    ...
    for request in all_requests:
        ...
        if request.echo and request.logprobs:
            logger.warning(
                ...
                "To compute logprobs of input prompt, please use Coalinfer /request API."
            )
