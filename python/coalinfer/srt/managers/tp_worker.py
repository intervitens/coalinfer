"""
Copyright 2023-2024 Coalinfer Team
...
from coalinfer.srt.constrained.fsm_cache import FSMCache
from coalinfer.srt.constrained.jump_forward import JumpForwardCache
from coalinfer.srt.hf_transformers_utils import get_processor, get_tokenizer
from coalinfer.srt.layers.logits_processor import LogitsProcessorOutput
from coalinfer.srt.managers.io_struct import (
    AbortReq,
    BatchEmbeddingOut,
    BatchTokenIDOut,
    FlushCacheReq,
...
from coalinfer.srt.managers.policy_scheduler import PolicyScheduler, PrefillAdder
from coalinfer.srt.managers.schedule_batch import (
    FINISH_ABORT,
    BaseFinishReason,
    Req,
    ScheduleBatch,
)
from coalinfer.srt.mem_cache.chunk_cache import ChunkCache
from coalinfer.srt.mem_cache.radix_cache import RadixCache
...
from coalinfer.srt.utils import (
    configure_logger,
    is_multimodal_model,
    set_random_seed,
    suppress_other_loggers,
)
from coalinfer.utils import get_exception_traceback

logger = logging.getLogger(__name__)


# Crash on warning if we are running CI tests
crash_on_warning = os.getenv("COALINFER_IS_IN_CI", "false") == "true"
