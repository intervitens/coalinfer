"""
Usage:
python3 -m coalinfer.test.run_eval --port 30000 --eval-name mmlu --num-examples 10
"""
...
from coalinfer.test.simple_eval_common import (
...
def run_eval(args):
    ...
    if args.eval_name == "mmlu":
        from coalinfer.test.simple_eval_mmlu import MMLUEval
        ...
        from coalinfer.test.simple_eval_math import MathEval
        ...
        from coalinfer.test.simple_eval_mgsm import MGSMEval
        ...
        from coalinfer.test.simple_eval_gpqa import GPQAEval
        ...
        from coalinfer.test.simple_eval_humaneval import HumanEval
