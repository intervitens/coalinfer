...
from coalinfer.lang.backend.openai import OpenAI
...
if os.getenv("COALINFER_IS_IN_CI", "false") == "true":
...
def add_common_coalinfer_args_and_parse(parser: argparse.ArgumentParser):
    parser.add_argument("--parallel", type=int, default=64)
    parser.add_argument("--host", type=str, default="http://127.0.0.1")
...
def select_coalinfer_backend(args: argparse.Namespace):
