# How to reproduce the benchmark results of Coalinfer

## Prerequisite

### Install the latest Coalinfer
...
python -m coalinfer.launch_server --model-path meta-llama/Meta-Llama-3.1-70B-Instruct --disable-radix-cache --tp 8

# Meta-Llama-3-70B-Instruct-FP8
python -m coalinfer.launch_server --model-path neuralmagic/Meta-Llama-3-70B-Instruct-FP8 --disable-radix-cache --tp 8
```
...
```bash
python3 -m coalinfer.bench_serving --backend coalinfer --dataset-name random --num-prompts 4000 --random-input 1024 --random-output 1024 --output-file offline.jsonl
python3 -m coalinfer.bench_serving --backend coalinfer --dataset-name random --num-prompts 5000 --random-input 1024 --random-output 512 --output-file offline.jsonl
python3 -m coalinfer.bench_serving --backend coalinfer --dataset-name random --num-prompts 1000 --random-input 4096 --random-output 2048 --output-file offline.jsonl
python3 -m coalinfer.bench_serving --backend coalinfer --dataset-name random --num-prompts 2000 --random-input 4096 --random-output 1024 --output-file offline.jsonl
python3 -m coalinfer.bench_serving --backend coalinfer --dataset-name random --num-prompts 6000 --random-input 256 --random-output 512 --output-file offline.jsonl
python3 -m coalinfer.bench_serving --backend coalinfer --dataset-name sharegpt --num-prompts 3000 --output-file offline.jsonl
...
```bash
python3 -m coalinfer.bench_serving --backend coalinfer --dataset-name random --random-input 1024 --random-output 1024 --num-prompts 300 --request-rate 1 --output-file online.jsonl
python3 -m coalinfer.bench_serving --backend coalinfer --dataset-name random --random-input 1024 --random-output 1024 --num-prompts 600 --request-rate 2 --output-file online.jsonl
python3 -m coalinfer.bench_serving --backend coalinfer --dataset-name random --random-input 1024 --random-output 1024 --num-prompts 1200 --request-rate 4 --output-file online.jsonl
python3 -m coalinfer.bench_serving --backend coalinfer --dataset-name random --random-input 1024 --random-output 1024 --num-prompts 2400 --request-rate 8 --output-file online.jsonl
python3 -m coalinfer.bench_serving --backend coalinfer --dataset-name random --random-input 1024 --random-output 1024 --num-prompts 3200 --request-rate 16 --output-file online.jsonl
...
```bash
wget https://raw.githubusercontent.com/sgl-project/coalinfer/main/python/coalinfer/bench_serving.py
```
