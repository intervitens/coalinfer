...
Launch a server
```
python3 -m coalinfer.launch_server --model-path liuhaotian/llava-v1.5-7b --tokenizer-path llava-hf/llava-1.5-7b-hf --port 30000
```

Run benchmark
```
# Run with local models
python3 bench_coalinfer.py --num-questions 60

# Run with OpenAI models
python3 bench_coalinfer.py --num-questions 60 --backend gpt-4-vision-preview
```
...
cd ~/coalinfer/benchmark/llava_bench
...
OPENAI_BASE_URL=http://localhost:23000/v1 python3 bench_coalinfer.py --backend gpt-4-vision-preview --num-q 1
```
