...
from coalinfer.lang.ir import REGEX_FLOAT, REGEX_INT, REGEX_STR
from coalinfer.test.test_utils import (
    add_common_coalinfer_args_and_parse,
    select_coalinfer_backend,
)
from coalinfer.utils import dump_state_text, read_jsonl
...
def main(args):
    ...
    # Select backend
    backend = select_coalinfer_backend(args)
